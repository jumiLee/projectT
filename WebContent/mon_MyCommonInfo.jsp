...
try{
	...
	//WebClient webClient = (WebClient)getServletContext().getAttribute("chatClient");
	
	//Conn = DriverManager.getConnection(DB_url, DB_user, DB_pwd);
	Conn = DriverManager.getConnection(DB_url_replica, DB_user, DB_pwd);
	
//System.out.println ("/////////// mon_MyCommonMonInfo  /////////// ");	
//몬스터 정보
	sql.append(" Call abn_getMonList (1, " + user_account + ", null,null) \n");
...
//몬스터 스킬 정보	
	sql.setLength(0);
	sql.append(" Call abn_getMonSkill (1, " + user_account + ", null,null) \n");
...
//몬스터 장착 정보	
	sql.setLength(0);
	sql.append(" Call abn_getMonEquip (1, " + user_account + ", null,null) \n");
...
//사용자 몬스터 체크 상태 업데이트 
	Conn = DriverManager.getConnection(DB_url, DB_user, DB_pwd);
	sql.setLength(0);
	sql.append(" Call abn_MgmtUserMonster (2," + user_account + ", null,null,null,null, null) \n");
	ResultSet rs_ck = null;
	PreparedStatement pstmt_ck = null;
	pstmt_ck = Conn.prepareStatement(sql.toString());
	rs_ck 	 = pstmt_ck.executeQuery();
