...
String BackUrl = request.getHeader("REFERER")==null?"main.jsp":request.getHeader("REFERER");
if(!BackUrl.equals("main.jsp")){
	BackUrl = new String(request.getHeader("REFERER").getBytes("8859_1"), "utf-8");
}
//String BackUrl = new String(request.getHeader("REFERER").getBytes("8859_1"), "utf-8");

System.out.println("파라미터 확인 ====>"+strParam);
String contextRoot = request.getContextPath();
String curr_url = request.getRequestURI() + "?" + strParam;
String encodeUrl = java.net.URLEncoder.encode(curr_url, "utf-8");
System.out.println("이전 주소 ====>"+BackUrl);
System.out.println("현재 주소 =====>"+curr_url);
//이미지Url Global변수 설정(이미지 서버 구축되면 변경)
String ImgUrl = request.getContextPath()+"/test";
System.out.println(" getContextPath====>"+ImgUrl);
String ua = request.getHeader("User-Agent").toLowerCase();
%>	
	<title>Mondeath</title>
	<meta charset="utf-8">
