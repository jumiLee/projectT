  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: './images/etc/percentImage_back2.png',			// boxImage : image around the progress bar
			barImage	: './images/etc/percentImage_back.png',	// Image to use in the progressbar. Can be an array of images too.
