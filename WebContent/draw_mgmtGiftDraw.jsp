...
<%
String P_type 	= request.getParameter("P_type");	//p_type
...
try{
	...
	//sql.append(" EXEC [dbo].[abn_MgmtUserGiftDraw] "+ user_account + ", " + draw_id + ", 2  \n");
	sql.append(" Call abn_MgmtUserGiftDraw  ("+ user_account + "," + draw_id + "," + 2 + " )\n") ;
	//System.out.println ("GiftDraw:" + sql.toString());
