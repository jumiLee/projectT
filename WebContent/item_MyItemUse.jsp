...
try{
	...
	cs.registerOutParameter(6, java.sql.Types.INTEGER);	 //result_cd
	cs.registerOutParameter(7, java.sql.Types.VARCHAR);	 //result_msg
	cs.execute();
	result_cd 	= cs.getInt(6);
	result_msg 	= cs.getString(7);
	
	//System.out.println ("아이템사용(" + result_cd + ") :" +result_msg );
}catch(Exception e){
