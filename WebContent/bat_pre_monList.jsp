...
<%
String P_type ="T23";
//String bat_result = request.getParameter("bat_result"); //승,패 선택
...
try{
	...
	sql.append(" Call abn_getBatList  (3," + user_account + ",null,null,null )\n") ;
	...
	while(rs.next()){
		...
		map.put("bat_result"	, rs.getInt(17));
		map.put("bat_user_img"	, rs.getInt(18));
